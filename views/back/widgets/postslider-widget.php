...
class VeusePostsliderWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'veuse_postslider_widget', // Base ID
			'Posts slider (Veuse)', // Name
			array( 'description' => __( 'Display blog posts in a slider.', 'veuse-uikit' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $title ) )
			...
			echo do_shortcode('[veuse_postslider categories="'. $category .'" orderby="'.$orderby.'" order="'.$order.'" perpage="'.$perpage.'" width="'.$width.'" height="'.$height.'"]');
...
add_action('widgets_init',create_function('','return register_widget("VeusePostsliderWidget");'));
