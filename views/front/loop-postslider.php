		...
		<?php
			...
			<li>
				<?php 
					...
					<div class="veuse-postslider-date"><span><i class="fa fa-clock-o fa-lg"></i> <?php the_date();?></span><span class="veuse-postslider-comments"><a href="<?php comments_link(); ?>"> <i class="fa fa-comments-o fa-lg"></i> <?php comments_number( '0', '1', '%' ); ?></a></span></div>
