...
class VeusePostsWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $title ) )
			...
			echo do_shortcode('[veuse_postlist categories="'. $category .'" orderby="'.$orderby.'" order="'.$order.'" perpage="'.$perpage.'" width="'.$width.'" height="'.$height.'"]');
...
add_action('widgets_init',create_function('','return register_widget("VeusePostsWidget");'));
