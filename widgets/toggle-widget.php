...
class VeuseToggleWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'veuse_tabs_widget', // Base ID
			__('Toggle','veuse-uikit'), // Name
			array( 'description' => __( 'Add a toggle button', 'veuse-uikit' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		//if ( ! empty( $title ) )
			...
			echo do_shortcode('[veuse_toggle title="'.$title.'" icon="'.$tab_icon .'"]'. $tab_content.'[/veuse_toggle]');
	...
	public function form( $instance ) {
		...
		<textarea class="widefat"  name="<?php echo $this->get_field_name( 'tab_content' ); ?>"><?php echo esc_attr($tab_content);?></textarea></p>
...
add_action('widgets_init',create_function('','return register_widget("VeuseToggleWidget");'));
